...
1. Face Visibility: The face must be fully visible, looking directly forward at the camera.
2. Lighting: The lighting must be soft and even, with no harsh shadows, overexposure, or colored tints on the face.
3. Eyes: Eyes must be open, looking at the camera, and not obscured by sunglasses, hair, or shadows.
4. Occlusions: No hands, toys, pacifiers, food, masks, hats, or hands covering any part of the face (cheeks, nose, mouth, chin, forehead).
5. Quality/Resolution: The photo must be clear, not blurry, and have reasonable resolution (not pixelated). No heavy filters.

OUTPUT RULES:
You MUST return a JSON object with this exact structure:
{
  "score": "not_usable" | "not_good" | "acceptable" | "great",
  "issues": string[], // Choose from: "poor_lighting", "blurry_or_low_res", "occluded_face", "eyes_closed", "not_front_facing", "extreme_expression", "heavy_filter"
...
- "not_usable": Eyes closed, face covered, side profile only, extremely blurry, or heavy filter. Will fail generation.`;
